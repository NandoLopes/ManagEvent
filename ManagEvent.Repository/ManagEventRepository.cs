...
{
    public class ManagEventRepository : IManagEventRepository
    {
        public readonly ManagEventContext _context;
        public ManagEventRepository(ManagEventContext context)
        {
            _context = context;
